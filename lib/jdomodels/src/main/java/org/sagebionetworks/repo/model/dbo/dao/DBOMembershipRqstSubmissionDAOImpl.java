...
public class DBOMembershipRqstSubmissionDAOImpl implements MembershipRqstSubmissionDAO {
	...
	private static final String SELECT_OPEN_REQUESTS_CORE = 
			" FROM "+TABLE_MEMBERSHIP_REQUEST_SUBMISSION+" mrs"
			+ " WHERE mrs."+COL_MEMBERSHIP_REQUEST_SUBMISSION_TEAM_ID+" NOT IN ("
					+ "SELECT "+COL_GROUP_MEMBERS_GROUP_ID
					+" FROM "+TABLE_GROUP_MEMBERS
					+" WHERE "+COL_GROUP_MEMBERS_MEMBER_ID+"=mrs."+COL_MEMBERSHIP_REQUEST_SUBMISSION_USER_ID
					+" ) "
